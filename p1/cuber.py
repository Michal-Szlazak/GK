...
class Cuber:
    ...
    def __init__(self, filename):
        ...
        self.translated_vertices = np.zeros((24, 4))
        self.vertices = np.zeros((24, 4))
        self.clipped_vertices = np.zeros((24, 4))
    ...
    def clip_edges(self, near, far):
        ...
        for edge in self.edges:
            clipped_edge = self.clip_line(edge, near, far)
            if clipped_edge:
    ...
    def draw_edges(self, window, color):
        ...
        for i in range(0, len(self.translated_vertices), 2):
            ...
            pygame.draw.circle(window, color, (self.translated_vertices[i][0], self.translated_vertices[i][1]), 5)
    ...
    def clip_line(self, edge, near, far):
    ...
    def project(self, fov, aspect_ratio, near, far):
        ...
        # print("clippedverlen ", len(self.clipped_vertices))
